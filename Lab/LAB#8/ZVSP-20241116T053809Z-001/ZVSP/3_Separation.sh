...
suxwigb < $output_dn title="Downgoing" perc=99 style=vsp key=gelev curve=$tt_picks npair=$nrec,1 curvecolor=red label2="Depth (ft)" label1="Time (s)"&
suxwigb < $output_res title="Residual-1" perc=99 style=vsp key=gelev curve=$tt_picks npair=$nrec,1 curvecolor=red label2="Depth (ft)" label1="Time (s)"&
suxwigb < $output_up title="Upgoing" perc=99 style=vsp key=gelev curve=$tt_picks npair=$nrec,1 curvecolor=red label2="Depth (ft)" label1="Time (s)"&
suxwigb < $output_res2 title="Residual-2" perc=99 style=vsp key=gelev curve=$tt_picks npair=$nrec,1 curvecolor=red label2="Depth (ft)" label1="Time (s)"&
