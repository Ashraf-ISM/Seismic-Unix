...
window_pick=0.015 #you need to test this
#process
...
suxwigb < $output title="ZVSP Raw 1st Arrival Picking" perc=99 style=vsp key=gelev \
	curve=$output_picks npair=$nrec,1 curvecolor=red label2="Depth (ft)" label1="Time (s)"&
